...
namespace BitcoinLib.Services
{
    ...
    public partial class CoinService : ICoinService
    {
        ...
        public string GetNewAddress(string account, string address_type)
        {
            if (string.IsNullOrWhiteSpace(address_type) == false)
            {
                return _rpcConnector.MakeRequest<string>(RpcMethods.getnewaddress, account, address_type);
            }
            else
            {
