...
public class ChannelDeamonManager : MonoBehaviour
{
    ...
    IEnumerator StopServiceAsync()
    {
        ...
        Debug.LogError("stop Start" + GlobalData.bLiveChannel);
        ...
        Debug.LogError("stop after1 check bLive" + bLiveChannel);
        ...
        yield return Ninja.JumpToUnity;
        Debug.LogError("stop after check" + GlobalData.bLiveChannel);
        ...
        if (bLiveChannel)
        {
            ...
            Debug.LogError("channelService stop-request-time:" + Time.timeSinceLevelLoad);
            ...
            yield return Ninja.JumpToUnity;
            Debug.LogError("channelService stop-final-time:" + Time.timeSinceLevelLoad);
